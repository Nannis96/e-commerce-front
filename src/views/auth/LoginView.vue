    ...
    <div class="w-full flex justify-center px-8">
      ...
      <div>
        <div class="text-center">
          <h2 class="text-3xl font-bold text-gray-900">Sign in to MediaSpace</h2>
          <p class="mt-2 text-sm text-gray-600">
            Or
            <router-link to="/register" class="font-medium text-rose-600 hover:text-rose-500">
        ...
        <div class="rounded-md shadow-sm -space-y-px">
          <div>
            ...
            <input
              ...
              autocomplete="email"
              required
              class="relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-rose-500 focus:border-rose-500 focus:z-10 text-sm"
          ...
          <div>
            ...
            <input
              ...
              required
              class="relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-rose-500 focus:border-rose-500 focus:z-10 text-sm"
